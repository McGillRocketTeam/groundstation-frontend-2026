...
function ComboboxTrigger(
	...
	const combinedProps = mergeProps<typeof ComboboxPrimitive.Trigger>(
		{
			className:
				"flex bg-[canvas] h-10 min-w-[12rem] items-center justify-between gap-3 border pr-3 pl-3.5 text-base select-none hover:bg-muted focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-1 focus-visible:outline-blue-800 data-[popup-open]:bg-muted cursor-default aria-invalid:ring-error/15 dark:aria-invalid:ring-error/40 aria-invalid:border-error sm:text-sm",
		},
		props,
	);
...
function ComboboxItem(
	...
	const combinedProps = mergeProps<typeof ComboboxPrimitive.Item>(
		{
			className:
				"grid min-w-[var(--anchor-width)] cursor-default grid-cols-[0.75rem_1fr] items-center gap-2 py-2 pr-8 pl-4 text-base leading-4 outline-none select-none data-[highlighted]:relative data-[highlighted]:z-0 data-[highlighted]:text-gray-50 data-[highlighted]:before:absolute data-[highlighted]:before:inset-x-2 data-[highlighted]:before:inset-y-0 data-[highlighted]:before:z-[-1] data-[highlighted]:before:bg-gray-900 sm:text-sm",
		},
		props,
	);
